...
public class ScheduleOrderDayTO extends TimestampTO implements Serializable {
	...
	private double dcShipmentWorkHours;
	...
	public double getDcShipmentWorkHours() {
		return dcShipmentWorkHours;
	}
	public void setDcShipmentWorkHours(double dcShipmentWorkHours) {
	...
	public int hashCode() {
		...
		long temp;
		temp = Double.doubleToLongBits(dcShipmentWorkHours);
	...
	public boolean equals(Object obj) {
		...
		if (dcEndWorkShiftSequenceNumber != other.dcEndWorkShiftSequenceNumber)
			return false;
		if (Double.doubleToLongBits(dcShipmentWorkHours) != Double
				.doubleToLongBits(other.dcShipmentWorkHours))
			return false;
